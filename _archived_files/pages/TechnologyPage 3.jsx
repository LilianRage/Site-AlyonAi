  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-20 min-h-screen flex">
        ...
        <AnimatePresence>
          {selectedModule && (
            <motion.div
              ...
              className="fixed right-0 top-0 bottom-0 w-full lg:w-1/2 bg-white border-l border-gray-200 z-40 overflow-y-auto pt-20"
            >
              <div className="p-8 lg:p-12">
                {/* Bouton fermer */}
                <button
                  onClick={closePanel}
                  className="absolute top-24 right-6 p-3 rounded-full border border-gray-200 hover:bg-black hover:text-white hover:border-black transition-all duration-300"
                >
                  <X className="w-5 h-5" />
                </button>
                ...
                <div className="mb-10">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <h2 className="text-3xl font-bold text-black">{selectedModule.name}</h2>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {selectedModule.features.map((feature, index) => (
                      <div 
                        key={index}
                        className="flex items-center gap-3 p-4 border border-gray-200 hover:border-black hover:bg-gray-50 transition-all duration-300"
                      >
        ...
        {/* Instructions quand aucun module sélectionné */}
        {!selectedModule && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <p className="text-gray-600 text-sm bg-white px-6 py-3 border border-gray-200 shadow-sm">
              Cliquez sur un numéro pour découvrir le module correspondant
            </p>
          </motion.div>
        )}
      </main>
